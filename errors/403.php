...
<head>
  ...
  <title>Access not available - AAZDSGN</title>
      ...
      <article class="article">
        <header class="article__header">
          <div class="container" style="text-align:center; padding-top: 60px;">
            ...
            <h1 class="article__heading heading heading--size-large">Access not available</h1>
          </div>
        </header>
        <div class="article__main container" style="text-align:center; padding: 24px 0 80px;">
          <p style="max-width: 560px; margin: 0 auto 32px;">This area is not publicly available. Please return to the main website.</p>
