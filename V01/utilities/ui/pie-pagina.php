<?php $rutapie="<?php echo $base_url; ?>/V01/utilities/tema/";?>
<!-- Vendor js -->
...
<script src="<?php echo $rutapie;?>libs/libs/sweetalert2/sweetalert2.min.js?v=<?php echo $v;?>"></script>
 ...
 <!-- Vendor js -->
        ...
        <script src="<?php echo $rutapie;?>libs/jquery-tabledit/jquery.tabledit.min.js"></script>

        <!-- Table editable init-->
        <script src="<?php echo $base_url; ?>/V01/assets/js/pages/tabledit.init.js"></script>

        <!-- App js -->
        <script src="<?php echo $base_url; ?>/V01/assets/js/app.min.js"></script>
