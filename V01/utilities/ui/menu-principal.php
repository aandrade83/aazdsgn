<?php 
    define('URL', 'https://' . $_SERVER['SERVER_NAME'] . '/V01/');
 ?>
<div class="left-side-menu">
    ...
    <div class="slimscroll-menu">
        ...
        <div id="sidebar-menu">
                           ...
                           <li class="menu-title">Navigation</li>
                            ...
                            <li class="active">
                                ...
                                <ul class="nav-second-level collapse in" aria-expanded="false" style="">
                                    <li>
                                        <a href="<?php echo $base_url; ?>/V01/apps/menu/index.php">Menu</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $base_url; ?>/V01/apps/mainPage/index.php">Pagina Principal</a>
                                       
                                    </li>
                                     <li>
                                        <a href="<?php echo $base_url; ?>/V01/apps/projects/index.php">Categorias</a>
                                    </li>
                                    <li>
         ...
         <dv id="div_saving" style="display: none"> 
            <img src="../../utilities/tema/images/saving.gif" style="width: 300px">
         </div>   
