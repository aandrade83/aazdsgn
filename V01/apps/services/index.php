...
$data_esp = get_page_data(4);
$en = get_page_data(4,'_en');
            ...
            <table class="table table-bordered editable-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="editable"><? echo $esp->vars['descripcion'] ?></td>
                        <td class="editable"><? echo $en[$i]->vars['descripcion'] ?></td>
