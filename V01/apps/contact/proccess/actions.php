...
case "Services":
    ...
    $destDir = "/var/www/vhosts/aazdsgn.com/images.aazdsgn.com/services/uploads/";
    ...
    if ($img_control) {
        ...
        if ($url1_file) $pag_esp->vars['url']  = 'https://images.aazdsgn.com/services/uploads/'.$url1_file;
        if ($url2_file) $pag_esp->vars['url2'] = 'https://images.aazdsgn.com/services/uploads/'.$url2_file;
    ...
    if ($img_control) {
        ...
        if ($url1_file) $pag_en->vars['url']  = 'https://images.aazdsgn.com/services/uploads/'.$url1_file;
        if ($url2_file) $pag_en->vars['url2'] = 'https://images.aazdsgn.com/services/uploads/'.$url2_file;
        $pag_en->vars['alt'] = $alt;
    }
    ...
    if ($url1_file) $data['url']  = 'https://images.aazdsgn.com/services/uploads/'.$url1_file;
    if ($url2_file) $data['url2'] = 'https://images.aazdsgn.com/services/uploads/'.$url2_file;
